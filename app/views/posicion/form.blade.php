<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
	<div class="form-group">
		...
		{{ Form::select('equipo_id', $equipos, null, array('class'=>'form-control','required'=>'true'))}}<br>
...
<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
	<div class="form-group">
		...
		{{ Form::text('goles_f', null, array('class'=>'form-control','required'=>'true'))}}<br>
		{{ Form::label('goles_c','Goles en contra')}}
		{{ Form::text('goles_c', null, array('class'=>'form-control','required'=>'true'))}}<br>
	</div>
</div>