...
<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-md-offset-2">
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h2 class="panel-title"><span class="glyphicon glyphicon-flag"> Nuevo Equipo</h2>
		</div>
		<div class="panel-body">
			{{ Form::open(array('url' => 'admin/equipo/guardar', 'files' => true)) }}
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="sobrenombre" name="sobrenombre" maxlength="30" required>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					<div class="form-group">
